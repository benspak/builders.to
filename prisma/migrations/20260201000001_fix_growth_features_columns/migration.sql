-- Fix Growth Features Migration
-- This migration safely adds columns that may be missing from the User table
-- Uses IF NOT EXISTS pattern to avoid errors if columns already exist
...
-- ============================================
-- Safely Add User Columns (if not exist)
-- ============================================
...
-- ============================================
-- Safely Add Karma Index
-- ============================================

CREATE INDEX IF NOT EXISTS "User_karma_idx" ON "User"("karma");

-- ============================================
-- Safely Add NotificationType Values
-- ============================================
...
-- ============================================
-- Safely Create AccountabilityPartnership Table
-- ============================================
...
-- ============================================
-- Safely Create AccountabilityCheckIn Table
-- ============================================
...
-- ============================================
-- Safely Create KarmaEvent Table
-- ============================================
