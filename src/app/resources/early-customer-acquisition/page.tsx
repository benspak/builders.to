...
export default function EarlyCustomerAcquisitionPage() {

  return (
    <ResourcePageWrapper
      resourceTitle="Early Customer Acquisition Playbook"
      delay={20}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-spotify-green/20 to-blue-500/20 p-8 rounded-lg border border-gray-700 mb-12">
          <blockquote className="text-center">
            ...
            <cite className="text-spotify-green text-lg">— Paul Graham, Y Combinator Co-founder</cite>
          </blockquote>
        </div>
          ...
          <div className="bg-dark-card p-6 rounded-lg border border-gray-700">
            ...
            <div className="bg-spotify-green/10 border border-spotify-green/30 p-4 rounded-lg mt-4">
              <p className="text-white font-semibold">
                💡 <strong>The Expert Response:</strong> "Early customer acquisition isn't about being pushy—it's about being helpful. The best founders become teachers who guide customers past their problems. This playbook will show you exactly how to do that with proven scripts and strategies."
              </p>
            </div>
          </div>
        </div>

        {/* Section 1: The Psychology of Early Customer Acquisition */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">1. The Psychology of Early Customer Acquisition</h2>
        ...
        {/* Section 3: The Perfect Sales Script Framework */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">3. The Perfect Sales Script Framework</h2>

          <div className="bg-dark-card p-8 rounded-lg border border-gray-700 mb-8">
            <h3 className="text-2xl font-semibold text-white mb-6">From "SPIN Selling" by Neil Rackham</h3>
            <p className="text-gray-300 mb-6">
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/50 p-6 rounded-lg">
                <h4 className="text-lg font-semibold text-spotify-green mb-3">The SPIN Framework in Action</h4>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="text-white font-semibold mb-2">Situation Questions</h5>
                    <p className="text-gray-300 text-sm mb-2">"Tell me about your current [process/situation]..."</p>
                    <p className="text-gray-300 text-sm">Example: "Tell me about how you currently handle customer support."</p>
                  </div>
                  <div>
                    <h5 className="text-white font-semibold mb-2">Problem Questions</h5>
                    <p className="text-gray-300 text-sm mb-2">"What challenges are you facing with [situation]?"</p>
                    <p className="text-gray-300 text-sm">Example: "What's the biggest challenge with your current support system?"</p>
                  </div>
                  <div>
                    <h5 className="text-white font-semibold mb-2">Implication Questions</h5>
                    <p className="text-gray-300 text-sm mb-2">"How does that affect [business outcome]?"</p>
                    <p className="text-gray-300 text-sm">Example: "How does slow response times affect customer satisfaction?"</p>
                  </div>
                  <div>
                    <h5 className="text-white font-semibold mb-2">Need-payoff Questions</h5>
                    <p className="text-gray-300 text-sm mb-2">"What would it mean if you could [solve problem]?"</p>
                    <p className="text-gray-300 text-sm">Example: "What would it mean if you could respond to customers instantly?"</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-dark-card p-6 rounded-lg border border-gray-700">
              <h4 className="text-xl font-semibold text-white mb-4">The "Problem-Agitation-Solution" Script</h4>
              <div className="space-y-4">
                <div>
                  <h5 className="text-spotify-green font-semibold mb-2">1. Problem (30 seconds)</h5>
                  <p className="text-gray-300 text-sm">"I noticed that [specific problem] is costing companies like yours [specific cost/impact]."</p>
                </div>
                <div>
                  <h5 className="text-spotify-green font-semibold mb-2">2. Agitation (30 seconds)</h5>
                  <p className="text-gray-300 text-sm">"Without solving this, you'll continue to [negative consequences] and miss out on [opportunity cost]."</p>
                </div>
                <div>
                  <h5 className="text-spotify-green font-semibold mb-2">3. Solution (30 seconds)</h5>
                  <p className="text-gray-300 text-sm">"We help companies like yours [specific benefit] by [your solution]. Would you be interested in a 15-minute call to see if this could work for you?"</p>
                </div>
              </div>
            </div>

            <div className="bg-dark-card p-6 rounded-lg border border-gray-700">
              <h4 className="text-xl font-semibold text-white mb-4">The "Value-First" Script</h4>
              <div className="space-y-4">
                <div>
                  <h5 className="text-spotify-green font-semibold mb-2">1. Permission (10 seconds)</h5>
                  <p className="text-gray-300 text-sm">"Hi [Name], I have a quick question about [their industry]. Do you have 2 minutes?"</p>
                </div>
                <div>
                  <h5 className="text-spotify-green font-semibold mb-2">2. Value (60 seconds)</h5>
                  <p className="text-gray-300 text-sm">"I just helped [similar company] [specific result]. I'm curious—what's your biggest challenge with [relevant area]?"</p>
                </div>
                <div>
                  <h5 className="text-spotify-green font-semibold mb-2">3. Next Step (30 seconds)</h5>
                  <p className="text-gray-300 text-sm">"I'd love to share how we achieved that result. Are you free for a 15-minute call this week?"</p>
                </div>
              </div>
            </div>
          </div>
