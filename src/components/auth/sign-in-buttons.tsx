  ...
  return (
    <div className={cn("flex flex-col gap-4", className)}>
      <button
        ...
        className="group relative flex items-center justify-center gap-3 rounded-xl bg-[#5865F2] px-6 py-4 font-semibold text-white transition-all hover:bg-[#4752C4] hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-[#5865F2]/25"
      >
        <DiscordIcon className="h-6 w-6" />
        <span>Continue with Discord</span>
        <div className="absolute inset-0 rounded-xl ring-2 ring-white/20 ring-inset" />
      </button>
