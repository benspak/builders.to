/**
 * Email verification template for verifying user email addresses
...
export function generateVerificationEmail({
  verificationUrl,
  baseUrl,
}: VerificationEmailOptions): { html: string; text: string } {
  const html = `
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Verify your email for Builders.to</title>
</head>
<body style="margin: 0; padding: 0; background-color: #09090b; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px;">
          <!-- Header -->
          <tr>
            <td style="padding: 32px; background: linear-gradient(135deg, rgba(34, 197, 94, 0.2) 0%, rgba(34, 197, 94, 0.05) 100%); border-radius: 16px 16px 0 0;">
              <table width="100%">
                <tr>
                  <td>
          ...
          <tr>
            <td style="padding: 40px 32px; background-color: #18181b; border-left: 1px solid rgba(255,255,255,0.1); border-right: 1px solid rgba(255,255,255,0.1);">
              <table width="100%">
                <tr>
                  <td align="center">
                    <a href="${verificationUrl}" style="display: inline-block; padding: 18px 48px; background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%); color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; border-radius: 12px; box-shadow: 0 4px 14px 0 rgba(34, 197, 94, 0.39);">
          ...
          <tr>
            <td style="padding: 24px 32px; background-color: #18181b; border-left: 1px solid rgba(255,255,255,0.1); border-right: 1px solid rgba(255,255,255,0.1);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding: 20px; background-color: rgba(34, 197, 94, 0.1); border-radius: 12px; border: 1px solid rgba(34, 197, 94, 0.2);">
                    <p style="margin: 0 0 12px; font-size: 14px; font-weight: 600; color: #22c55e;">
                      Why verify your email?
                    </p>
                    <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #a1a1aa;">
                      <li style="margin-bottom: 8px;">Receive notifications when builders interact with your content</li>
                      <li style="margin-bottom: 8px;">Get activity digests and milestone celebrations</li>
                ...
                <tr>
                  <td style="padding: 16px; background-color: rgba(251, 191, 36, 0.1); border-radius: 12px; border: 1px solid rgba(251, 191, 36, 0.2);">
                    <p style="margin: 0; font-size: 13px; color: #fbbf24;">
                      🔒 If you didn't create a Builders.to account, you can safely ignore this email.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding: 24px 32px; background-color: #18181b; border-left: 1px solid rgba(255,255,255,0.1); border-right: 1px solid rgba(255,255,255,0.1);">
              ...
              <p style="margin: 12px 0 0; font-size: 12px; color: #52525b; text-align: center; word-break: break-all;">
                <a href="${verificationUrl}" style="color: #22c55e; text-decoration: underline;">
                  ${verificationUrl}
                </a>
              </p>
            </td>
  ...
  const text = `
Verify Your Email for Builders.to
...
Why verify your email?
- Receive notifications when builders interact with your content
- Get activity digests and milestone celebrations
- Enable two-factor authentication for extra security
- Recover your account if you ever lose access
